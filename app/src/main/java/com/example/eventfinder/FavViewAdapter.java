...
public class EventsTableViewAdapter extends RecyclerView.Adapter {
    ...
    public EventsTableViewAdapter(Context context, ArrayList eventNames, ArrayList eventIcons, ArrayList eventDates, ArrayList eventTimes, ArrayList eventVenues, ArrayList eventCategories, ArrayList eventIds) {
